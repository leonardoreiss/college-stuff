/*
 * 25)(IF) Solicite do usuário a quantidade de maças, 
 * peras e bananas que ele comprou. Você terá que perguntar 
 * também o preço de cada uma das frutas. Informe quanto o usuário 
 * gastou na quitanda.  Neste momento solicite do usuário quanto ele 
 * está dando para pagamento e forneça o valor do troco. Se o dinheiro dado 
 * não for suficiente, informe esse problema para o usuário.
 */
